...
class BookingController extends Controller
{
    ...
    {
        $this->audit->log('booking.deleted', targetPatientId: $booking->patient_id, details: "Booking: {$booking->booking_number}", request: $request);
        $this->bookingService->delete($booking, $request->user());
